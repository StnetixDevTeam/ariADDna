...
public class ErrorModel {
     ...
     * @return code
     **/
    @ApiModelProperty(example = "null", required = true, value = "Contains error code massage.")
     ...
     * @return message
     **/
    @ApiModelProperty(example = "null", required = true, value = "Contains short error message.")
