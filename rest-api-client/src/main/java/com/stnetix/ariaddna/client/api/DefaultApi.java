...
public class DefaultApi {
    ...
    private com.squareup.okhttp.Call getDiffVUFSCall(String userUuid, DateTime lastCreationTime, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
        
        // create path and map variables
        String localVarPath = "/vufs/snap/diff/{userUuid}/{lastCreationTime}".replaceAll("\\{format\\}","json")
        .replaceAll("\\{" + "userUuid" + "\\}", apiClient.escapeString(userUuid.toString()))
        .replaceAll("\\{" + "lastCreationTime" + "\\}", apiClient.escapeString(lastCreationTime.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call getDiffVUFSValidateBeforeCall(String userUuid, DateTime lastCreationTime, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        // verify the required parameter 'lastCreationTime' is set
        if (lastCreationTime == null) {
            throw new ApiException("Missing the required parameter 'lastCreationTime' when calling getDiffVUFS(Async)");
        }
        
        
        com.squareup.okhttp.Call call = getDiffVUFSCall(userUuid, lastCreationTime, progressListener, progressRequestListener);
        return call;
     ...
     * @param lastCreationTime Parametr fromDateTime of current VUFS snapshot (required)
     * @return Vufs
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public Vufs getDiffVUFS(String userUuid, DateTime lastCreationTime) throws ApiException {
        ApiResponse<Vufs> resp = getDiffVUFSWithHttpInfo(userUuid, lastCreationTime);
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<Vufs> getDiffVUFSWithHttpInfo(String userUuid, DateTime lastCreationTime) throws ApiException {
        com.squareup.okhttp.Call call = getDiffVUFSValidateBeforeCall(userUuid, lastCreationTime, null, null);
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call getDiffVUFSAsync(String userUuid, DateTime lastCreationTime, final ApiCallback<Vufs> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getDiffVUFSValidateBeforeCall(userUuid, lastCreationTime, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<Vufs>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
