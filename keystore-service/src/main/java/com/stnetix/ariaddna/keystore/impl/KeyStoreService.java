...
public class KeyStoreService implements IKeyStore {
    ...
    @Override
    public File generateDisableKeyStore() throws KeyStoreException {
        return KeyFactory.getKeyFactory().getDisableKeyStore();
    }
    ...
    @Override
    public void disableCert(File certFile, File keyStoreFrom, File keyStoreTo) throws KeyStoreException {
        KeyFactory.getKeyFactory().removeCertFromKeyStore(certFile, keyStoreFrom);
        KeyFactory.getKeyFactory().storeCertToKeyStore(certFile,keyStoreTo);
