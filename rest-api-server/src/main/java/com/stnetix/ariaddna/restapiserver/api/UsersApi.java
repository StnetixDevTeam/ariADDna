...
public interface UsersApi {
    ...
    @ApiOperation(value = "", notes = "Allows one to create a new user.", response = User.class, tags = {
            "Ariaddna", })
    @ApiResponses(value = {
    ...
    @ApiOperation(value = "", notes = "Changing user password.", response = Void.class, tags = {
            "Ariaddna", })
    @ApiResponses(value = {
    ...
    @ApiOperation(value = "", notes = "Deleting user.", response = Void.class, tags = {
            "Ariaddna", })
    @ApiResponses(value = {
    ...
    @ApiOperation(value = "", notes = "This operation allows one to get back information about certain user providing his UUID as a path parameter.", response = User.class, tags = {
            "Ariaddna", })
    @ApiResponses(value = {
    ...
    @ApiOperation(value = "", notes = "Returns a list of clouds which a certain user has connected to his ariADDna account.", response = CloudSetPages.class, tags = {
            "Ariaddna", })
    @ApiResponses(value = {
    ...
    @RequestMapping(value = "/users/{userUuid}/clouds",
            ...
            consumes = { "application/json" },
            method = RequestMethod.GET)
    ResponseEntity<CloudSetPages> getExternalCloudAccounts(
